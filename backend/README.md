...
## Project Structure
    ...
    ├── testapiautoconnect_106339  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_106339`
...
2. Clone this repo and `cd testapiautoconnect_106339`
